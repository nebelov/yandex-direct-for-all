...
Все процессы совместно соблюдают не более 10 запросов в секунду и 100 запросов в час для всех четырёх методов. `getRegionsTree` входит в оба ограничения, но отдельно записывается с нулевой стоимостью.
