...
Глобальный навык для работы с performance-маркетингом Яндекса из любой папки на макбуке.
...
- [source_inventory.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/source_inventory.md)
- [completeness_audit_2026-03-05.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/completeness_audit_2026-03-05.md)
...
- [wordstat_collection_framework.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/wordstat_collection_framework.md)
- [future_session_start_checklist.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/future_session_start_checklist.md)
...
- launcher: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/codex_cli_swarm_manual_review.py`
- search prompt: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/codex_swarm_search_worker_prompt.md`
- rsya prompt: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/codex_swarm_rsya_worker_prompt.md`
- search schema: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/schemas/codex_swarm_search_chunk_response.schema.json`
- rsya schema: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/schemas/codex_swarm_rsya_chunk_response.schema.json`
...
- собрать search SQR на то же окно через `direct-orchestrator/scripts/collector_search_query_wave.py` или fallback `~/.codex/skills/yandex-performance-ops/scripts/fetch_sqr.sh`;
...
- reusable creative builder: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/build_creative_rotation_from_outliers.py`;
- reusable growth builder: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/build_growth_structure_from_routes.py`;
...
- Если пользователь дал `go` на live apply после такого refresh, канонический reusable apply-path теперь такой:
  1. собрать text-rotation validation/apply pack через `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/build_text_rotation_apply_pack_from_tsv.py`;
  2. прогнать `dry-run`, затем live apply через `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/apply_ad_replacement_pack.py`;
  3. собрать manifest новых search adgroups и применить его через `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/apply_search_adgroup_manifest.py`;
...
- Search strict local pack builder: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/build_local_search_negatives_pack.py`
- Search live drift-check: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/dry_run_search_negatives_pack.py`
- RSYA strict local pack builder: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/build_local_rsya_excluded_sites_pack.py`
- RSYA validator: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/validate_excluded_sites_pack.py`
- RSYA live drift-check/apply helper: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/apply_no_moderation_pack.py`
...
- reusable script: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/search_negative_marker_engine.py`;
...
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/codex_cli_swarm_manual_review.py \
  --kind search \
...
- `~/.claude/skills/direct-optimization/SKILL.md`
...
- reusable script: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/prefilter_rsya_manual_queue.py`;
...
На этом макбуке есть архив client overlays, но они не активны по умолчанию без local project file или явного `YANDEX_PERFORMANCE_CLIENT_CONTEXT`:
- `/Users/vitalijtravin/.codex/clients/tenevoy/.codex/yandex-performance-client.json`

Шаблоны:
- [client_context.example.json](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/client_context.example.json)
- [routing_map.example.tsv](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/routing_map.example.tsv)
- [campaign_id_map.example.json](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/campaign_id_map.example.json)
- [copy_map.example.json](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/copy_map.example.json)

Описание полей:
- [local_overlay_contract.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/local_overlay_contract.md)
- [yandex_cloud_search_handoffs.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/yandex_cloud_search_handoffs.md)

Быстрый scaffold:
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/init_client_context.py \
...
- upstream research по SERP/footprint/competitor pages тоже не собирать вручную по одной фразе.
  ...
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/yandex_search_batch.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/yandex_search_ads_batch.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/build_domain_shortlist_from_serp.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/firecrawl_scrape.py --jobs-file ...`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/build_followup_jobs_from_serp.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/split_tsv_batch.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/merge_sitemap_batch_outputs.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/render_serp_wave.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/render_ad_serp_wave.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/render_sitemap_candidates.py`
  - `~/.codex/skills/yandex-direct-client-lifecycle/scripts/render_page_capture_inventory.py`
...
- reusable script: `/Users/vitalijtravin/.codex/skills/yandex-performance-ops/scripts/dry_run_search_negatives_pack.py`;
...
- канонический Wordstat entrypoint на этом маке:
  - `bash ~/.codex/skills/yandex-performance-ops/scripts/wordstat_tool.sh preflight ...`
  - `bash ~/.codex/skills/yandex-performance-ops/scripts/wordstat_tool.sh collect-wave ...`
  - `bash ~/.codex/skills/yandex-performance-ops/scripts/wordstat_tool.sh preflight-save ...`
...
- discovery order для Wordstat всегда такой:
  - global wrapper `~/.codex/skills/yandex-performance-ops/scripts/wordstat_tool.sh`;
...
- Если в локальном проекте cloud-search path еще не оформлен, но уже известно что на этом макбуке есть проверенный operational bundle, сначала проверить:
  - `/Users/vitalijtravin/.codex/credentials/yandex-cloud-search-tenevoy.json`
  - затем canonical source на `macbook-air-remote`, описанный в `references/yandex_cloud_search_handoffs.md`
...
- Для переноса локальных `md/json/txt/tsv` в сам YouGile использовать inline-bundle workflow:
  - `python3 ~/.codex/skills/yandex-performance-ops/scripts/push_yougile_file_bundle.py --chat-id <task_id> --file <path>`
...
- Новый client workspace в YouGile создавать только по API, без браузерного/ручного UI-path:
  - `python3 ~/.codex/skills/yandex-performance-ops/scripts/bootstrap_yougile_workspace.py --spec <json> --output <json>`
...
- Для `ExcludedSites after-pack` использовать скриптовую проверку:
  - `python3 ~/.codex/skills/yandex-performance-ops/scripts/validate_excluded_sites_pack.py --help`
- Для `ad replacement pack` использовать скриптовую проверку:
  - `python3 ~/.codex/skills/yandex-performance-ops/scripts/validate_ad_replacement_pack.py --help`
...
python3 ~/.codex/skills/yandex-performance-ops/scripts/oauth_get_token.py --help
```
4. Если есть Roistat, задать env и проверить query script.
5. Если нужен Metrika-layer, прочитать:
- [CONFIG.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/metrika/CONFIG.md)

### 2. Сбор новой семантики

Перед началом открыть:
- [wordstat_collection_framework.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/wordstat_collection_framework.md)
- [12_wordstat_collection_pipeline.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/12_wordstat_collection_pipeline.md)

1. Собрать локальную product map по шаблону:
- [wordstat_product_map_template.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/wordstat_product_map_template.md)

2. Сформировать `Wave 1` masks file по шаблону:
- [wordstat_masks_wave1_template.tsv](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/wordstat_masks_wave1_template.tsv)
...
```bash
bash ~/.codex/skills/yandex-performance-ops/scripts/fetch_sqr.sh \
...
- [agent_target_from_wave.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/agent_target_from_wave.md)
- [agent_negative_from_wave.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/agent_negative_from_wave.md)
- [agent_minus_words_from_negative.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/agent_minus_words_from_negative.md)
- [agent_validation_checklist.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/agent_validation_checklist.md)
...
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/build_manual_final_pack.py --help
python3 ~/.codex/skills/yandex-performance-ops/scripts/validate_and_cluster.py --help
```
3. Проверить live-state:
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/verify_live_readiness.py --help
python3 ~/.codex/skills/yandex-performance-ops/scripts/audit_group_ad_copy.py --help
python3 ~/.codex/skills/yandex-performance-ops/scripts/campaign_autotest.py --help
```
...
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/collect_all.py --help
```
2. Если нужен short-window operational review по окну `N` дней:
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/collect_operational_precheck.py --help
bash ~/.codex/skills/yandex-performance-ops/scripts/fetch_sqr.sh --help
```
   Правила:
...
3. Анализ по промтам:
- [full_audit_plan_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/full_audit_plan_prompt.md)
- [search_query_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/search_query_prompt.md)
- [ad_components_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/ad_components_prompt.md)
- [bids_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/bids_prompt.md)
- [structure_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/structure_prompt.md)
- [validate_negatives_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/validate_negatives_prompt.md)
- [aggregation_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/aggregation_prompt.md)
- [search_diagnostic_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/search_diagnostic_prompt.md)
- [rsy_placements_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/rsy_placements_prompt.md)
- [validate_placements_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/validate_placements_prompt.md)
- [validate_tasks_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/validate_tasks_prompt.md)
- [tasks_format.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/tasks_format.md)
- [diagnostic_agent_bundle_template.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/diagnostic_agent_bundle_template.md)
...
6. Dry-run:
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/apply_no_moderation_pack.py --help
python3 ~/.codex/skills/yandex-performance-ops/scripts/apply_tasks.py --help
python3 ~/.codex/skills/yandex-performance-ops/scripts/clone_search_groups_to_new_campaign.py --help
```
7. Пост-валидация:
- [post_apply_validation_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/post_apply_validation_prompt.md)
...
bash ~/.codex/skills/yandex-performance-ops/scripts/metrika/counters.sh
bash ~/.codex/skills/yandex-performance-ops/scripts/metrika/goals.sh --counter <ID>
```

Справка:
- [API_REFERENCE.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/metrika/API_REFERENCE.md)
- [CUSTOM_REPORTS.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/metrika/CUSTOM_REPORTS.md)
- [PERIOD_COMPARISON.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/metrika/PERIOD_COMPARISON.md)
- [SEARCH_QUERIES.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/metrika/SEARCH_QUERIES.md)
...
2. Построить прогноз:
```bash
python3 ~/.codex/skills/yandex-performance-ops/scripts/forecast_engine.py --help
python3 ~/.codex/skills/yandex-performance-ops/scripts/test_forecast.py --help
```
3. При необходимости использовать шаблон:
- [media_plan_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/media_plan_prompt.md)

### 7. Competitor creative research

Использовать для сбора рекламных сообщений и креативных паттернов конкурентов:
- [competitor_research_workflow.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/competitor_research_workflow.md)
- [competitor_research_prompt.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/competitor_research_prompt.md)

### 8. Post-cycle revision

После завершения волны работ обязательно пройти:
- [agent_skill_revision_checklist.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/templates/agent_skill_revision_checklist.md)
- [lessons_registry.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/lessons_registry.md)
...
- [00_output_contract.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/00_output_contract.md)
- [01_search_negatives_7d.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/01_search_negatives_7d.md)
- [02_rsy_stop_sites_7d.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/02_rsy_stop_sites_7d.md)
- [03_creative_outliers_rotation.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/03_creative_outliers_rotation.md)
- [04_deep_campaign_review_7d.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/04_deep_campaign_review_7d.md)
- [05_change_impact_timeline.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/05_change_impact_timeline.md)
- [06_bids_and_modifiers_review.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/06_bids_and_modifiers_review.md)
- [07_yougile_hygiene_sync.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/07_yougile_hygiene_sync.md)
- [08_competitor_search_serp.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/08_competitor_search_serp.md)
- [09_missing_phrases_growth.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/09_missing_phrases_growth.md)
- [10_extra_control_layers.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/10_extra_control_layers.md)
- [11_pre_apply_presentation.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/11_pre_apply_presentation.md)
- [12_wordstat_collection_pipeline.md](/Users/vitalijtravin/.codex/skills/yandex-performance-ops/references/task_playbooks/12_wordstat_collection_pipeline.md)
...
- если в проекте уже есть local generator/discovery scripts, использовать их как fallback или client-specific overlay; для Wordstat preflight/collector по умолчанию сначала использовать `~/.codex/skills/yandex-performance-ops/scripts/wordstat_tool.sh`.
...
```bash
test -f ~/.codex/skills/yandex-performance-ops/SKILL.md
python3 ~/.codex/skills/yandex-performance-ops/scripts/oauth_get_token.py --help
bash ~/.codex/skills/yandex-performance-ops/scripts/wordstat_preflight.sh
python3 ~/.codex/skills/yandex-performance-ops/scripts/campaign_autotest.py --help
```
